    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"CALM Green"} hasDropdown={false}/>
            ...
            <img src={selected_green_background} className='home-pages-img-container' alt="logo"></img>
