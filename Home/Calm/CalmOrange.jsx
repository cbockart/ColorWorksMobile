    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"CALM Orange"} hasDropdown={false}/>
            ...
            <img src={selected_orange_background} className='home-pages-img-container' alt="logo"></img>
