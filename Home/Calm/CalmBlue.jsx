    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"CALM Blue"} hasDropdown={false}/>
            ...
            <img src={selected_blue_background} className='home-pages-img-container' alt="logo"></img>
