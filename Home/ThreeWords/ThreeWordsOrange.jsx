    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"3 Words Orange"} hasDropdown={false}/>
            ...
            <GeneralParagraphsComponent text1={"Oranges"}></GeneralParagraphsComponent> 
            <div className='threewords-lessbold-lg-text'>
                Freedom, Rewards, Boundaries
            </div>

            {/*3 words Image*/}
            <img src={selected_orange_background} className='threeWords-colorworks-image' alt="logo"></img>

            <ColorWorksText type={'subheader'} inputText={'Freedom'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Rewards'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Boundaries'}></ColorWorksText>
            <div className='colorworks-information-text'>
...
export default ThreeWordsOrange;