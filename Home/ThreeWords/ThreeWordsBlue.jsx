    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"3 Words Blues"} hasDropdown={false}/>
            ...
            <GeneralParagraphsComponent text1={"Blues"}></GeneralParagraphsComponent> 
            ...
            <ColorWorksText type={'subheader'} inputText={'Connections'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Communication'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Understanding'}></ColorWorksText>
            <div className='colorworks-information-text'>
