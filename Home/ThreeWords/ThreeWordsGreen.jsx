    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"3 Words Green"} hasDropdown={false}/>
            ...
            <GeneralParagraphsComponent text1={"Green"}></GeneralParagraphsComponent> 
            <div className='threewords-lessbold-lg-text'>
                Information, Logic, Experiences
            </div>

            {/*3 words Image*/}
            <img src={selected_green_background} className='threeWords-colorworks-image' alt="logo"></img>

            <ColorWorksText type={'subheader'} inputText={'Information'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Logic'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Experiences'}></ColorWorksText>
            <div className='colorworks-information-text'>
...
export default ThreeWordsGreen;