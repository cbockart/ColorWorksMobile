    ...
    return (
      <>
        <div className='home-pages-whole-container'>
            <TopHeader />
            <HomePageTopSection headerText={"3 Words Gold"} hasDropdown={false}/>
            ...
            <GeneralParagraphsComponent text1={"Golds"}></GeneralParagraphsComponent> 
            <div className='threewords-lessbold-lg-text'>
                Structure, Consistency, Expectations
            </div>

            {/*3 words Image*/}
            <img src={selected_gold_background} className='threeWords-colorworks-image' alt="logo"></img>

            <ColorWorksText type={'subheader'} inputText={'Structure'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Consistency'}></ColorWorksText>
            <div className='colorworks-information-text'>
            ...
            <ColorWorksText type={'subheader'} inputText={'Expectations'}></ColorWorksText>
            <div className='colorworks-information-text'>
